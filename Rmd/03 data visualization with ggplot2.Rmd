...
**`ggplot`** code looks unique because it uses `+` at the end of each line. The `+` is related to `%>%` but not exactly the same because it doesn't the order of elements rarely matters. 
